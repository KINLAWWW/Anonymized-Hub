...
from swinmi.models import CrossformerForMI
...
def build_dataset():
    ...
    return HSSMIDataset(
        ...
        sampling_rate=128,  
        offline_transform=transforms.ToTensor(),
